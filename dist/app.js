...
},{"./store":"../../../../../libs/client/src/store/index.js","./createClient":"../../../../../libs/client/src/createClient.js","./ui":"../../../../../libs/client/src/ui/index.js","./globals":"../../../../../libs/client/src/globals.js"}],"store/actions/changeRoute.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  observables: {
    ...
    // -1: left, 1: right,
    'menu.level': 0,
    // 0: default level, 1: first level (child), ...
    // pages
    currentPage: 'app',
    // dash, app
    // dash
    'dash.submenu': '' // settings, ...

  }
};
exports.default = _default;
},{"./actions":"store/actions/index.js"}],"ui/components/Input.js":[function(require,module,exports) {
"use strict";
...
var Input = function Input(client) {
  return client.hoc({
    ...
    render: function render(_ref) {
      ...
      return client.html(_templateObject(), type, placeholder, value, styles.input, onInput, actions.onKeyDown);
    }
  });
};
...
},{"./Input":"ui/components/Input.js"}],"ui/fragments/Menu.js":[function(require,module,exports) {
"use strict";
...
var Menu = function Menu(client) {
  ...
  return client.hoc({
    ...
    actions: function actions(props, store) {
      return {
        onClick: function onClick() {
          var level = store.get('menu.level');
          var position = store.get('menu.position');
    ...
    styles: {
      handle: function handle(position, level) {
        return "\n        position: absolute;\n        width: 58%;\n        height: 58%;\n        background: hsl(0, 0%, 98%);\n        border-radius: 50%;\n        z-index: 10;\n        transform:\n          scale(".concat(level > 0 ? 0 : 1.1, ")\n          translate3d(").concat(position === -1 ? -20 : 80, "%, 0, 0);\n        transition: all .35s ease;\n        box-shadow: inset 0px 0px 6px hsla(0, 0%, 0%, 0.6);\n      ");
      },
      topLine: function topLine(level) {
        return "\n        transform:\n          rotateZ(".concat(level > 0 ? -44 : 0, "deg)\n          scale(").concat(level > 0 ? 0.7 : 1, ", 1);\n      ");
      },
      bottomLine: function bottomLine(level) {
        return "\n        transform:\n          rotateZ(".concat(level > 0 ? 44 : 0, "deg)\n          scale(").concat(level > 0 ? 0.7 : 1, ", 1);\n      ");
      }
    },
    render: function render(_ref) {
      ...
      var position = state.position,
          level = state.level;
      return client.html(_templateObject(), classes.wrapper, actions.onClick, styles.handle(position, level), classes.line, styles.topLine(level), classes.line, styles.bottomLine(level));
    }
  });
};
...
},{"./Menu":"ui/fragments/Menu.js"}],"ui/pages/<App>/App.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(client) {
  return client.hoc({
    ...
    render: function render(_ref) {
      ...
      return client.html(_templateObject(), styles.app(currentPage === 'app'));
    }
  });
};

exports.default = _default;
},{}],"ui/pages/<Dashboard>/<Settings>/Settings.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(client) {
  return client.hoc({
    render: function render() {
      return client.html(_templateObject());
    }
  });
};

exports.default = _default;
},{}],"ui/pages/<Dashboard>/<Help>/Help.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"ui/pages/<Dashboard>/<Legal>/Legal.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"ui/pages/<Dashboard>/<Profile>/Profile.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"ui/pages/<Dashboard>/Dashboard.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(client) {
  return client.hoc({
    ...
    styles: {
      dash: function dash(isVisible) {
        return "\n        display: flex;\n        position: absolute;\n        justify-content: center;\n        align-items: center;\n        min-width: 100%;\n        height: 100%;\n        transition: all .6s ease-out;\n        overflow: hidden;\n        opacity: ".concat(isVisible ? 1 : 0, ";\n        pointer-events: ").concat(isVisible ? 'auto' : 'none', ";\n      ");
      },
      screen: function screen(isVisible) {
        return "\n        position: absolute;\n        display: flex;\n        flex-flow: column;\n        justify-content: center;\n        align-items: center;\n        min-width: 100%;\n        height: 100%;\n        transition: all .5s ease-out;\n        background: white;\n        transform: translate3d(".concat(isVisible ? 0 : 100, "%, 0, 0);\n        pointer-events: ").concat(isVisible ? 'auto' : 'none', ";\n      ");
      }
    },
    render: function render(_ref) {
      var styles = _ref.styles,
      ...
      var currentPage = state.currentPage,
          ...
          level = state.level;
      return client.html(_templateObject(), styles.dash(currentPage === 'dash'), Object.keys(sections).map(function (key) {
        var isVisible = level === 1 && submenu === key.toLowerCase();
        return client.html(_templateObject2(), styles.screen(isVisible), sections[key]());
      }), classes.submenus, Object.keys(sections).map(function (key) {
        return client.html(_templateObject3(), classes.submenu, function () {
          return actions.onClick(key);
        }, key);
      }), classes.submenu);
    }
  });
...
exports.default = _default;
},{"./<Settings>/Settings.js":"ui/pages/<Dashboard>/<Settings>/Settings.js","./<Help>/Help.js":"ui/pages/<Dashboard>/<Help>/Help.js","./<Legal>/Legal.js":"ui/pages/<Dashboard>/<Legal>/Legal.js","./<Profile>/Profile.js":"ui/pages/<Dashboard>/<Profile>/Profile.js"}],"ui/Root.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(client) {
  var Menu = client.ui.fragments.Menu;
  return client.hoc({
    classes: {
      wrapper: "\n        position: relative;\n        height: 100vh;\n        width: 100%;\n      ",
      menu: "\n        position: absolute;\n        top: 12px;\n        left: 12px;\n        cursor: pointer;\n        z-index: 10;\n        user-select: none;\n      ",
    ...
    sections: {
      App: require("./pages/<App>/App.js").default,
      Dashboard: require("./pages/<Dashboard>/Dashboard.js").default
    },
    render: function render(_ref) {
      var classes = _ref.classes,
          sections = _ref.sections;
      return client.html(_templateObject(), classes.wrapper, classes.menu, Menu(), classes.pages, sections.App(), sections.Dashboard());
    }
  });
};

exports.default = _default;
},{"./pages/<App>/App.js":"ui/pages/<App>/App.js","./pages/<Dashboard>/Dashboard.js":"ui/pages/<Dashboard>/Dashboard.js"}],"../config.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./client/store":"store/index.js","./client/ui/components":"ui/components/index.js","./client/ui/fragments":"ui/fragments/index.js","./client/ui/Root":"ui/Root.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var _index = require("../../../../../libs/client/src/index.js");
...
console.log("client", _index.client);

var _default = _index.client.init(_config.default.client);

exports.default = _default;
},{"../../../../../libs/client/src/index.js":"../../../../../libs/client/src/index.js","../config.js":"../config.js"}]},{},["app.js"], null)
